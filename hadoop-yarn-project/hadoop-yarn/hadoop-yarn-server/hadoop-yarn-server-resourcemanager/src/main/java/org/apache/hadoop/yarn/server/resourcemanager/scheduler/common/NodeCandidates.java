...
public class NodeCandidates<N extends SchedulerNode> {
  private N nextAvailable;
  private Map<NodeId, N> allSchedulableNodes;
  private String partition;

  public NodeCandidates(N nextAvailable, Collection<N> allSchedulable,
      String partition) {
    this.nextAvailable = nextAvailable;
    this.allSchedulableNodes = new HashMap<>();
    if (null != allSchedulable) {
      for (N n : allSchedulable) {
        allSchedulableNodes.put(n.getNodeID(), n);
      }
    }
